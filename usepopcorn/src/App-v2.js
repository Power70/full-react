...
const average = (arr) =>
      ...
      async function fetchMovies() {
        ...
        try {
          ...
          setError("");
            ...
            // the message is the message that was pass in the throw new error above
            // the err is the actual err that was passed into the catch function
  ...
  function MovieDetails ({selectedId, onCloseMovie, onAddWatched, watched}){
    ...
    const {
      ...
      // handle a global key press event on our applications
      useEffect(function(){
